...
const ErrorMessage = ({ text, cssProp }) => {
    
    return (

        <div class={"mx-10 mb-10 bg-red-200 border-t-4 border-red-700 rounded-b text-red-900 px-4 py-3 shadow-md " + cssProp} role="alert">
            <div class="flex">
                <div class="py-1">
